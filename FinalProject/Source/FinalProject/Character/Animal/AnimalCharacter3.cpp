...
// Sets default values
AAnimalCharacter3::AAnimalCharacter3()
{
	...
	static ConstructorHelpers::FObjectFinder <USkeletalMesh>SkelaetalMesh(TEXT("Skeleton'/Game/InfinityBladeAdversaries/Enemy/Enemy_Golem/SK_Fire_Golem.SK_Fire_Golem'"));
	// Set Material Texture
	static ConstructorHelpers::FObjectFinder <UMaterialInterface>Material_(TEXT("Material'/Game/InfinityBladeAdversaries/Enemy/Enemy_Golem/Materials/CharM_Fire_Golem.CharM_Fire_Golem'"));
	//애니메이션 스테이트머신
	static ConstructorHelpers::FObjectFinder<UAnimBlueprint> lAnimBlueprint(TEXT("AnimBlueprint'/Game/InfinityBladeAdversaries/Enemy/Enemy_Golem/SK_Mannequin_Skeleton_AnimBlueprint.SK_Mannequin_Skeleton_AnimBlueprint'"));
...
void AAnimalCharacter3::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void AAnimalCharacter3::Tick(float DeltaTime)
{
	...
	if (bDeath == true) {
		...
		aAttackTask* attack = new aAttackTask(this->Controller, AgroTarget, bDamage, 18.0f);
...
void AAnimalCharacter3::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
