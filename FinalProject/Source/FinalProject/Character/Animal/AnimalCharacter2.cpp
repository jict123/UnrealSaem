...
// Sets default values
AAnimalCharacter2::AAnimalCharacter2()
{
	...
	static ConstructorHelpers::FObjectFinder <USkeletalMesh>SkelaetalMesh(TEXT("Skeleton'/Game/InfinityBladeAdversaries/Enemy/Enemy_Gruntling_Avalanche/SK_Gruntling_Avalanche.SK_Gruntling_Avalanche'"));
	// Set Material Texture
	static ConstructorHelpers::FObjectFinder <UMaterialInterface>Material_(TEXT("Material'/Game/InfinityBladeAdversaries/Enemy/Enemy_Gruntling_Avalanche/Materials/CharM_Gruntling_Avalanche.CharM_Gruntling_Avalanche'"));
	//애니메이션 스테이트머신
	static ConstructorHelpers::FObjectFinder<UAnimBlueprint> lAnimBlueprint(TEXT("AnimBlueprint'/Game/InfinityBladeAdversaries/Enemy/Enemy_Gruntling_Avalanche/SK_Gruntling_Avalanche_Skeleton_AnimBlueprint.SK_Gruntling_Avalanche_Skeleton_AnimBlueprint'"));
...
void AAnimalCharacter2::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void AAnimalCharacter2::Tick(float DeltaTime)
{
	...
	if (bDeath == true) {
		...
		aMoveTargetTask* target = new aMoveTargetTask(this->Controller, AgroTarget, 500.0F);
		aAttackTask* attack = new aAttackTask(this->Controller, AgroTarget, bDamage, 8.0f);
...
void AAnimalCharacter2::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
