...
#include "HumanCharacter2.h"
#include "Character/Human/HumanAIController.h"
#include "FinalProjectGameMode.h"
#include "BehaviorTree/HumanBehaviorTree.h"
// Sets default values
AHumanCharacter2::AHumanCharacter2()
{
	// Set this character to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;
	hHp = 60.0f;		//초기 hp값
	// Set StaticMesh Object
	static ConstructorHelpers::FObjectFinder <USkeletalMesh>SkelaetalMesh(TEXT("Skeleton'/Game/MixamoAnimPack/Mixamo_SWAT/Mesh/Maximo_SWAT.Maximo_SWAT'"));
	// Set Material Texture
	static ConstructorHelpers::FObjectFinder <UMaterialInterface>Material_(TEXT("Material'/Game/MixamoAnimPack/Mixamo_SWAT/Materials/Swat_Mat.Swat_Mat'"));
	//애니메이션 스테이트머신
	static ConstructorHelpers::FObjectFinder<UAnimBlueprint> lAnimBlueprint(TEXT("AnimBlueprint'/Game/MixamoAnimPack/Mixamo_SWAT/Anims/MixamoAnimBP_SWAT.MixamoAnimBP_SWAT'"));
...
void AHumanCharacter2::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void AHumanCharacter2::Tick(float DeltaTime)
{
	...
	if (bDeath == true) {
		...
		movetarget = new hMoveTargetTask(this->Controller, AgroTarget, 600.0F);
		attack = new hAttackTask(this->Controller, AgroTarget,bDamage, 8.0f);
...
void AHumanCharacter2::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
