...
#include "HumanBuilding_Create2.h"
...
// Sets default values
AHumanBuilding_Create2::AHumanBuilding_Create2()
{
	...
	static ConstructorHelpers::FObjectFinder <UMaterialInterface>Material_(TEXT("Material'/Game/StarterContent/Materials/M_Brick_Cut_Stone.M_Brick_Cut_Stone'"));
...
void AHumanBuilding_Create2::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AHumanBuilding_Create2::Tick(float DeltaTime)
{
...
void AHumanBuilding_Create2::NotifyActorOnClicked()
{
	...
	MainUIWidget = CreateWidget<UUserWidget>(GetWorld(), MainUIWidgetClass1);
